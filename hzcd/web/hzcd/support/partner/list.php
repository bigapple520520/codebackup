...
<body>
<div id="navigator">合作伙伴管理  >>  合作伙伴列表</div>
<div id="titleMain">
    <div id="current" onclick="location.href='list.php';">合作伙伴列表</div>
...
<div id="tableMain">
    ...
    <table id="dataTable" border="0" align="center" cellpadding="5" cellspacing="1">
		<tr class="titleTr">
			...
			<td align="center">图标地址</td>
			<td align="center">正文介绍</td>
		...
		<tr>
			...
			<td align="center"><?php echo $value["icon"]; ?></td>
